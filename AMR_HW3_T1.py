...
def main():
    ...
    pygame.display.set_caption("Test Case 1 - only v is constant & w = 0")
    clock = pygame.time.Clock()
    font = pygame.font.Font(None, 24) # Smaller font for axis labels
    info_font = pygame.font.Font(None, 30)

    # --- Test Case 1 Setup ---
    # Constant linear velocity, zero angular velocity
    V_ROBOT = 10  # pixels per second
    W_ROBOT = 0  # radians per second
    
    # Initialize robot at the center (origin), facing 30 degrees upwards from horizontal
    origin_x, origin_y = SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2
    initial_theta = 0
